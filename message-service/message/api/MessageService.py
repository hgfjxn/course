...
class Client(Iface):
    ...
    def sendMobileMessage(self, mobile, content):
        ...
        Parameters:
         ...
         - content
        """
        self.send_sendMobileMessage(mobile, content)
        return self.recv_sendMobileMessage()

    def send_sendMobileMessage(self, mobile, content):
    ...
    def sendEmailMessage(self, email, content):
        ...
        Parameters:
         ...
         - content
        """
        self.send_sendEmailMessage(email, content)
        return self.recv_sendEmailMessage()

    def send_sendEmailMessage(self, email, content):
...
class Processor(Iface, TProcessor):
    ...
    def process_sendMobileMessage(self, seqid, iprot, oprot):
        ...
        result = sendMobileMessage_result()
        try:
            result.success = self._handler.sendMobileMessage(args.mobile, args.content)
    ...
    def process_sendEmailMessage(self, seqid, iprot, oprot):
        ...
        result = sendEmailMessage_result()
        try:
            result.success = self._handler.sendEmailMessage(args.email, args.content)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
class sendMobileMessage_args(object):
    ...
    def __init__(self, mobile=None, content=None,):
        self.mobile = mobile
